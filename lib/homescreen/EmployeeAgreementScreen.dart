...
class Employeeagreementscreen extends StatefulWidget {
  @override
  _EmployeeAgreementState createState() => _EmployeeAgreementState();
}

class _EmployeeAgreementState extends State<Employeeagreementscreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(body: Obx(() {
      ...
      var filteredTaskData =
          taskData.where((item) => item.role == 'employee').toList();
                      ...
                      child: CustomButton(
                        ...
                        onPressed: () {
                          if (!isChecked) {
                            ...
                            Navigator.pushNamed(
                                context, AppRoutes.employeeScreen);
                          }
                        },
                      ),
                    )
