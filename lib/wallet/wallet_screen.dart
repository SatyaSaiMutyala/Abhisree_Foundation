  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Obx(() {
        ...
        final withdrawalData = withdrawalDetailsController.WithdrawalDetails;
            ...
            Expanded(
              child: Padding(
                ...
                child: Obx(() {
                  ...
                  final filteredData = userData.where((user) {
                  ...
                  final filteredwithdrawData = withdrawalData.where((user) {
                    final createdAt = DateTime.parse(user.createdAt);
                    if (_startDate != null && createdAt.isBefore(_startDate!))
                      return false;
                    if (_endDate != null && createdAt.isAfter(_endDate!))
