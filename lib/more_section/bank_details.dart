...
class BankAccountsScreen extends StatelessWidget {
    ...
    return Center(
      child: Column(
        ...
        children: [
            ...
            child: Container(
              ...
              child: Center(
                child: Container(
                  width: width * 0.5,
                  height: height * 0.03,
                  child: Icon(Icons.add, size: width * 0.07, color: Color(0xFF338D9B)),
                ),
              ),
            ),
          ),
          ...
          Text(
            "Add New Account",
            style: TextStyle(fontSize: width * 0.04, fontWeight: FontWeight.w500, fontFamily: "Poppins",),
          ),
          SizedBox(height: height * 0.008),
          Text(
            "Add your bank details for your withdrawals",
            style: TextStyle(fontSize: width * 0.033, fontWeight: FontWeight.w500, fontFamily: "Inter", color: Color(0XFF6F6B6B)),
          ),
        ],
      ),
    );
 ...
 Widget _buildBankListView(BuildContext context) {
  ...
  return Column(
    children: [
      SizedBox(height: height * 0.12),  // Now this will work properly
      Expanded(  // Ensures ListView works inside Column
...
Widget _buildBankAccountCard(BuildContext context, String bankName, double width, double height) {
  return Column(
    children: [
      GestureDetector(  // Makes the card tappable
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => BankDetailsScreen(bankName: bankName), // Pass data if needed
            ),
          );
        },
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(Dimensions.radiusDefault), // Rounded corners
            border: Border.all(color: Color(0xFFE3DFDF), width: 1), // Border styling
            boxShadow: [
              BoxShadow(
          ...
          child: Row(
            ...
            children: [
              Row(
                children: [
                  Image.asset("assets/icons/sbi_icon.png", width: width * 0.1, height: height * 0.05),
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Text(
                        "Primary",
                        style: TextStyle(fontSize: width * 0.03, color: Color(0XFF039200)),
                      ),
                    ],
                  ),
                ],
              ),
              Icon(Icons.arrow_forward, size: width * 0.06, color: Colors.grey),
            ],
          ),
        ),
      ),
