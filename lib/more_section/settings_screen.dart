...
import 'package:adhisree_foundation/more_section/EarningsScreen.dart';
import 'package:adhisree_foundation/more_section/LegalDocsScreen.dart';
import 'package:adhisree_foundation/more_section/bank_details.dart';
import 'package:adhisree_foundation/more_section/documents_screen.dart';
import 'package:adhisree_foundation/more_section/profile_screen.dart';
import 'package:adhisree_foundation/more_section/yourDonationScreen.dart';
import 'package:adhisree_foundation/utils/dimensions.dart';
import 'package:adhisree_foundation/widgets/logout_form.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Obx(() {
        ...
        print(
            'This is Role Man 45***********${userProgressController.userProgress.value?.userType}');
          ...
          children: [
            ListView(
              ...
              children: [
                ...
                // Profile Section
                ListTile(
                  leading: Icon(Icons.person_4_outlined, color: Colors.blue, size: width * 0.06),
                  title: Text(
                    "Profile",
                    style: TextStyle(fontWeight: FontWeight.w500),
                  ),
                ...
                Divider(),
                 ListTile(
                  leading: Icon(Icons.monetization_on_outlined, color: Colors.blue, size: width * 0.06),
                  title: Text(
                    "Donations",
                    style: TextStyle(fontWeight: FontWeight.w500),
                  ),
                  subtitle: Text(
                    "View your donation history and total contributions at a glance.",
                    style: TextStyle(
                      fontSize: 12,
                      fontFamily: "Poppins",
                      fontWeight: FontWeight.w400,
                ...
                if (role == 'volunteer' || role == 'employee') ...[
                  ...
                  ListTile(
                    leading: Icon(Icons.volunteer_activism, color: Colors.blue, size: width * 0.06),
                    title: Text(
                      "Become a Volunteer",
                      style: TextStyle(fontWeight: FontWeight.w500),
                    ),
                  ...
                  Divider(),
                  ListTile(
                    leading: Icon(Icons.badge, color: Colors.blue,size: width * 0.06),
                    title: Text(
                      "Become a Co-Ordinator",
                      style: TextStyle(fontWeight: FontWeight.w500),
                    ),
                    subtitle: Text(
                      "Join us and start contributing as a Co-ordinator",
                      style: TextStyle(
                        fontSize: 12,
                        fontFamily: "Poppins",
                        fontWeight: FontWeight.w400,
                ...
                ListTile(
                  leading: Icon(Icons.picture_as_pdf, color: Colors.blue, size: width * 0.06),
                  title: Text(
                    "Brochure",
                    style: TextStyle(
                      fontFamily: "Poppins",
                ...
                Divider(),
                ListTile(
                  leading: Icon(Icons.edit_document, color: Colors.blue, size: width * 0.06),
                  title: Text(
                    "Legal Documents",
                    style: TextStyle(
                      fontFamily: "Poppins",
                  ...
                  subtitle: Text(
                    "View our detailed Legal Documents",
                    style: TextStyle(
                      fontFamily: "Poppins",
                      fontWeight: FontWeight.w400,
                      fontSize: 12,
                ...
                Divider(),
                ListTile(
                  leading: Icon(Icons.money_rounded, color: Colors.blue, size: width * 0.06),
                  title: Text(
                    "Earnings",
                    style: TextStyle(
                      fontFamily: "Poppins",
                ...
                ListTile(
                  leading: Icon(Icons.image, color: Colors.blue, size: width * 0.06),
                  title: Text(
                    "Gallary",
                    style: TextStyle(
                      fontFamily: "Poppins",
                ...
                Divider(),
                ListTile(
                  leading: Icon(Icons.quick_contacts_mail_outlined, color: Colors.blue, size: width * 0.06),
                  title: Text(
                    "Social Media",
                    style: TextStyle(
                      fontFamily: "Poppins",
                ...
                Divider(),
                ListTile(
                  leading: Icon(Icons.description, color: Colors.blue, size: width * 0.06),
                  title: Text(
                    "Terms & Conditions",
                    style: TextStyle(
                      fontFamily: "Poppins",
                ...
                Divider(),
                ListTile(
                  leading: Icon(Icons.privacy_tip, color: Colors.blue, size: width * 0.06),
                  title: Text(
                    "Privacy Policy",
                    style: TextStyle(
                      fontFamily: "Poppins",
                ...
                ListTile(
                  // leading: Image.asset("assets/icons/logout_icon.png"),
                  leading: Icon(Icons.logout, color: Colors.blue, size: width * 0.06),
                  title: Text(
                    "Logout",
                    style: TextStyle(fontWeight: FontWeight.w500),
                  ),
